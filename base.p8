...
function checkallcol(obj1,x_y)
 	local temp = objlist
		...
		while temp do
 		...
 		if (temp.value.id=="item" or temp.value.id=="blob") then if checkcol(obj1, temp.value,x_y)==true then if (temp.value.id=="item") then sfx(17) else sfx(22) end deleteobj(temp.value) end goto continue end			
